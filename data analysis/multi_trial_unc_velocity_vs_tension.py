...
from pulse_velocity import compute_pulse_velocity
...
def batch_multifile_velocity_avg(
    ...
    save_table_name='pulse_velocity_vs_pretension_multi_avg.csv',
    save_plot_name='pulse_velocity_vs_pretension_multi_avg.png',
    save_detail_name='pulse_velocity_vs_pretension_multi_details.csv',
    verbose=True
):
    """
...
summary_df, detail_df = batch_multifile_velocity_avg(
    root_dir=r'.\1D chain tension changing exp\8_19 main data',
    distance=DISTANCE,
